...
> - 本项目开发已经基本完成，精力有限请谅解，后续开发将会随缘随心，我对项目测试不一定完全，有问题欢迎提issue，感谢
> - 二次开发与引用请带上署名，感谢
...
## 🆕 版本更新
### v1.0.4-beta (2026-03-10) - 视觉优化
- ✅小升级：添加了正在执行/有效任务的统计胶囊视觉在导航栏


<details>
<summary>📋 历史版本更新日志</summary>

### v1.0.3-beta (2026-03-9) - 系统优化小幅度升级
- ✅ 优化了一键启动流畅性：迭代了下check_env、bat和docker-compose.server，现在一键启动更加流畅了
- ✅ 小升级：添加了抓取数据时价格排序功能
- ✅ 小修复：优化系统健康检测在数据库模式下的表现

### v1.0.2-beta (2026-03-9) - 系统优化
- ✅ **自定义的Prompt和Bayes补丁**：优化了Prompt 自定义配置和Bayes 自定义配置的生成逻辑，现在这两个自定义配置会入库且用户数据隔离

### v1.0.0-beta (2026-02-14) - 系统优化
祝大家春节快乐，节日繁忙，这个版本我测的不是很多，有问题欢迎提issue，我回来会尽快再更新

c支持多用户登录、会话管理与独立用户数据空间
